...
public class ApiConnection {
    ...
    private <T> T fetchData(String url, Class<T> responseClass) throws IOException, InterruptedException {
    ...
    public DriverResponse fetchDrivers() throws IOException, InterruptedException {
        String url = "https://v1.formula-1.api-sports.io/rankings/drivers?season=2023";
        return fetchData(url, DriverResponse.class);
    }

    public RaceResponse fetchRaces() throws IOException, InterruptedException {
        String url = "https://v1.formula-1.api-sports.io/races?season=2023";
